...
import { Flower, Dumbbell, Waves, Heart, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Flower key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Heart key={3} />],
